...
3. Collect model behavioral data and hypotheses [**(Ex: Refusals2Riches Dataset)**](https://airtable.com/appug6qgTztujHMkc/shr2A8eFo0SyM4FYE) and experiment with [open source tools](https://www.neelnanda.io/mechanistic-interpretability/getting-started). 
