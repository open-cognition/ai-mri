...
| 2     | [Systematic Cognitive Probes Taxonomy](https://airtable.com/appug6qgTztujHMkc/shrPIFRX1FcpKK0NO)      | A structured classification system treating prompts as probes that elicit specific cognitive or behavioral responses from models.          |
| 3     | [Probe → Model + AI MRI → Output Datasets](https://airtable.com/appug6qgTztujHMkc/shriMksJHdjGWQdoI) | Datasets that capture how scaffolded models respond to classified probes, mapping both refusal space and hypothesis generation.       |
