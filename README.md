...
Preliminary data, collected from over 375 outputs across the Claude, Gemini, and GPT model families using Anthropic Workbench, Google AI Studio, and OpenAI Playground, reveals a stark divergence: while baseline models provide terminal, uninformative refusals, models equipped with the AI MRI scaffold maintain their safety posture while additionally generating detailed mechanistic hypotheses about their own internal processes.
